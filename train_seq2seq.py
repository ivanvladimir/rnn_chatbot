...
if __name__ == '__main__':
    ...
    p.add_argument("--epochs",default=50,type=int,
            ...
            help="Epochs [10]")
    p.add_argument("--maxlen_input",default=20,type=int,
    ...
    answer_embedding = LSTM_decoder(word_embedding_answer,initial_state=[context_embedding,context_embedding])
    ...
    out = Dense(dictionary_size/2, activation="relu")(answer_embedding)
    ...
    num_subsets=1
    step = np.around(len(train_ans)/num_subsets)
